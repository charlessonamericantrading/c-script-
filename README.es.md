...
<div align="center">
  ...
  <p>
    ...
    <a href="#-testing--quality-assurance"><img src="https://img.shields.io/badge/tests-528-success.svg" alt="Tests" /></a>
    <a href="https://github.com/charlessonamericantrading/c-script-/releases"><img src="https://img.shields.io/badge/versión-1.6.0-blue.svg" alt="Versión" /></a>
...
**Funciona hoy**, cubierto por 528 pruebas automáticas:
...
| PostgreSQL sin LISTEN/NOTIFY | Dos instancias del servidor contra la misma base no ven las escrituras de la otra en un `stream`. (TLS y reconexión automática tras una conexión cortada ya están soportados -- ver arriba; un pool de conexiones no aporta nada acá, porque el intérprete es single-threaded y solo corre una query a la vez.) |
...
El compilador y el runtime de Link están verificados por **528 pruebas automáticas** unitarias,
