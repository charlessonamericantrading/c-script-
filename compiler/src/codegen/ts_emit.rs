...
pub(crate) fn render_type(ty: &Type) -> String {
    match ty {
        ...
        // GRAMMAR.md §3.268: `Html` es una disciplina de escape del lado
        // del SERVIDOR únicamente -- una vez que cruza el wire es texto
        // crudo, mismo criterio que Uuid/Timestamp arriba (tipo nominal
        // propio en c-script, `string` liso en TS).
        Type::Html => "string".to_string(),
        ...
        Type::Db | Type::DbCollection(_) | Type::DbQuery(_) | Type::Auth | Type::Service(_) | Type::Math | Type::Crypto | Type::Http | Type::Json | Type::Base64 | Type::Pdf | Type::Excel | Type::Ai | Type::Mcp | Type::Image | Type::Background | Type::Time | Type::Env | Type::Request | Type::Smtp | Type::Response => {
